        ...
        buttons={
          <>
            ...
            <button
              ...
              className="inline-flex h-10 items-center justify-center rounded-lg border border-border-heavy bg-surface-secondary px-4 py-2 text-sm text-text-primary hover:bg-[var(--construct-chat-yellow)] hover:text-white focus:bg-[var(--construct-chat-yellow)] focus:text-white dark:hover:bg-[var(--construct-chat-yellow-hover)] dark:focus:bg-[var(--construct-chat-yellow-hover)]"
            >
